...
public class JavaArrayCopyMutableObjects {
    ...
    public static void main(String[] args) {
        ...
        Employee[] empArray2 = fullCopy(empArray1); // deep copy

//        System.arraycopy(empArray1, 0, empArray2, 0, empArray1.length); // shallow copy

        System.out.println("empArray1 = "
                + Arrays.toString(empArray1));
        System.out.println("empArray2 = "
                + Arrays.toString(empArray2));
