...
public class JavaReadFileToString {
    ...
    public static void main(String[] args) {
        String fileName = "tmp/witcher.txt";

        String contents = readUsingBufferedReaderCharArray(fileName);
    ...
    // Should use this method to read non-char based files such as image, video etc.
